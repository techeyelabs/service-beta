...
<div class="project_item four_stickers extra_div small_screen_font" style="">
    <a href="#">
        <div  class="project_img small_sticker" style="height:220px; width:auto; background-color:#fff; background-image: url({{url('uploads/service/2.jpg')}});background-repeat: no-repeat;
    ...
    <div class="project_text" style="padding-top: 0px !important"> 
        ...
        <span class="project_title "><a style="font-size: 12px;  height: 36px" title="Title" class="title small_screen_font" href="">Title</a></span>
        ...
        <div class="row project_item_footer" >
            ...
            <div class="col-3 text-center" style="padding: 0px !important">
                    ...
                    {{-- <p style="font-size: 11px"> {{$interval}}</p> --}}
              
            </div>
            <!-- 現在 Current, 円 $ -->
            <div class="col-4" style="font-size: 11px; padding-left: 0px !important">
                <p class="text-right">10 donors</p>
            </div>
        </div>
    </div>
</div>  
