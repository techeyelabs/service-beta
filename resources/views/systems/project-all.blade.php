...
<div class="project_item four_stickers extra_div small_screen_font" style="">
    <a href="#">
        <div class="project_img small_sticker" style="height:220px; width:auto; background-color:#fff; background-image: url({{url('uploads/products/'.$p->thumbnail_image)}}); background-repeat: no-repeat;
    ...
    <div class="project_text" style="padding-top: 0px !important">
        <ul class="project_tags list-inline project_category_items">
            <li class="list-inline-item">
                <i class="fa fa-tag"></i> <a style="font-size: 10px" href="" class="category">{{$p->category->cat_name}}</a>

            </li>
        </ul>
        <span class="project_title "><a style="font-size: 12px;  height: 36px" title="Title"
                class="title small_screen_font" href="">{{str_limit($p->title, 55)}}</a></span>
