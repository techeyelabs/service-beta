                ...
                <div class="card">
                    <div class="header">
                        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                            ...
                            <li class="nav-item {{request()->get('active_tab') == 'affiliated-list'?'active':''}}">
                                <a class="nav-link" id="affiliated-tab" data-toggle="tab" href="#affiliated" role="tab"
                                    aria-controls="affiliated" aria-selected="false">Affiliated List</a>
                            </li>
                    ...
                    <div class="body">
                        <div class="tab-content" id="myTabContent">
                                                ...
                                                <table class="table" id="">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td><a href="{{route('admin-affiliator-earning-list-monthly', ['user_id' => $userInfo->id, 'source' => 'SALE'])}}">
                                                                {{-- {{$balance->affiliate_earning}} 円 --}}
                                                                {{\floor($sale)}} 円
                                                                </a></td>

                                                            <td>Recruiting Bonus</td>
                                                            <td><a href="{{route('admin-affiliator-earning-list-monthly', ['user_id' => $userInfo->id, 'source' => 'RECBONUS'])}}">
                                                                {{-- {{$balance->recruiting_bonus}} 円 --}}
                                                                {{\floor($recruitment)}} 円
                                                            </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Ranking Bonus</td>
                                                            <td><a href="{{route('admin-affiliator-earning-list-monthly', ['user_id' => $userInfo->id, 'source' => 'RANKBONUS'])}}">
                                                                {{-- {{$balance->ranking_bonus}} 円 --}}
                                                                {{\floor($rank)}} 円
                                                                </a>
                                                            </td>

                                                            <td>Lottery Bunus</td>
                                                            <td><a href="{{route('admin-affiliator-earning-list-monthly', ['user_id' => $userInfo->id, 'source' => 'LOTTERY'])}}">
                                                                {{-- {{$balance->lottery_bunus}} 円 --}}
                                                                {{\floor($lottery)}} 円
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>{{\floor($balance->remaining_amount)}} 円</td>
                                                                            
                                                            <td colspan="2"></td>
                                                            {{--<td>Total Amount</td>
                                                            <td>{{\floor($balance->total_amount)}} 円</td>--}}
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
                            ...
                            <div class="tab-pane fade {{request()->get('active_tab') == 'affiliated-list'?'active in':''}}" id="affiliated" role="tabpanel" aria-labelledby="affiliated-tab">
                                    <div class="card">

                                            <div class="header">
                                                <h2>Affiliated List</h2>
                                                <div class="header-dropdown m-r-0"></div>
                                            </div>
                                            ...
                                            <div class="body table-responsive">
                                                ...
                                                <table class="table" id="data-table">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center"> Affiliator </th>
                                                            <th class="text-center"> Product </th>
                                                            <th class="text-center"> Price </th>
                                                            <th class="text-center"> Line Link </th>
    ...
    $(document).ready(function () {
        var dataTableBalance = $('#data-table-balance').DataTable({
            ...
            var dataTablePurchase = $('#data-table-purchase').DataTable({
                ...
                //bSort: false,
                order: [ [6, 'desc'] ],
                ajax: "{{route('admin-affiliator-purchase-list-data', ['buyer_id' => Request::get('id')])}}",
                columns: [
        ...
        var dataTable = $('#data-table').DataTable({
            ...
            ajax: "{{route('admin-affiliated-product-list-data', ['user_id' => $userInfo->id])}}",
            columns: [{
                    data: 'affiliator',
                    name: 'affiliator'
                },
